...
import { validatePackaging, validatePartialPackaging } from "../validators/ValidatePackaging"
...
export default class StorePackaging {
    ...
    async validate(req: Request, res: Response, next: NextFunction) {
        ...
        const result = validatePackaging(req.body);
        if (!result.success) {
    ...
    async partialValidate(req: Request, res: Response, next: NextFunction) {
        ...
        const result = validatePartialPackaging(req.body);
